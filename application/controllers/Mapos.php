...
class Mapos extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['ordens1'] = $this->mapos_model->getOsAguardandoMateriais();
    ...
    public function minhaComissao()
    {
        $this->data['results'] = $this->mapos_model->getByIdComissao($this->session->userdata('id'));
        $this->data['view'] = 'mapos/minhaComissao';
        return $this->layout();
    }
    ...
    public function calendario()
    {
        ...
        $events = array_map(function ($os) {
            ...
            return [
                'title' => "Age.: {$os->idOs}, Cliente: {$os->nomeCliente}",
                'start' => $os->dataFinal,
                'end' => $os->dataFinal,
                'color' => $cor,
                'extendedProps' => [
                    ...
                    'dataFinal' => '<b>Agendamento:</b> ' . $os->dataFinal,
                    'garantia' => '<b>Horario:</b> ' . $os->horario,
                    'status' => '<b>Status do Agendamento:</b> ' . $os->status,
                    'description' => '<b>Profissional:</b> ' . $os->funcionario,
