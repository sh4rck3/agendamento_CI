...
<ul class="cardBox">
    ...
    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')) : ?>
        <li class="card">
            <div>
                <div class="numbers N-tittle">Agendamento</div>
        ...
        <div class="new-statisc">
            <div class="widget-box-new" style="height:100%">
                ...
                <div class="new-bottons">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/os/adicionar" class="card" title="Adicionar Agendamento" class="tip-bottom">
                        <div><i class='bx bxs-spreadsheet iconBx4'></i></div>
                        <div>
                            <div class="cardName2"><?= $this->db->count_all('os'); ?></div>
                            <div class="cardName">Add Agenda.</div>
                        </div>
                    </a>
...
<div class="span12A" style="margin-left: 0">
    ...
    <div class="widget-box0">
        <div>
            <h5 class="cardHeader">Agendamento com status "Em Aberto"</h5>
        </div>
        <div class="widget-content">
            <table class="table table-bordered">
                <thead>
    ...
    echo "";
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5">Nenhum Agendamento em aberto.</td>
                        </tr>
                    <?php endif ?>
                </tbody>
            </table>
    ...
    <div class="widget-box0">
        <div>
            <h5 class="cardHeader">Agendamento com status "Aguardando Material"</h5>
        </div>
        <div class="widget-content">
            <table class="table table-bordered">
                <thead>
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5">Nenhum Agendamento Aguardando Material.</td>
                        </tr>
                    <?php endif ?>
                </tbody>
            </table>
    ...
    <div class="widget-box0">
        <div>
            <h5 class="cardHeader">Agendamento com status "Em Andamento"</h5>
        </div>
        <div class="widget-content">
            <table class="table table-bordered">
                <thead>
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5">Nenhum Agendamento em Andamento.</td>
                        </tr>
                    <?php endif ?>
                </tbody>
            </table>
...
<div id="calendarModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        ...
        <h3 id="myModalLabel">Status do Agendamento Detalhado</h3>
    </div>
    <div class="modal-body">
        <div class="span12" id="divFormStatusOS" style="margin-left: 0"></div>
        <h4><b>Agendamento:</b> <span id="modalId" class="modal-id"></span></h4>
    ...
    <div class="modal-footer">
        ...
        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eOs')) {
            echo '<a id="modalIdEditar" style="margin-right: 1%" href="" class="btn btn-info tip-top" title="Editar"><i class="fas fa-edit"></i></a>';
        }
        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'dOs')) {
            echo '<a id="linkExcluir" href="#modal-excluir-os" role="button" data-toggle="modal" os="" class="btn btn-danger tip-top" title="Excluir"><i class="fas fa-trash-alt"></i></a>  ';
        }
        ?>
    </div>
</div>
