    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <ul class="nav nav-tabs">
                ...
                <li><a data-toggle="tab" href="#menu5">Agendamento</a></li>
            </ul>
            <form action="<?php echo current_url(); ?>" id="formConfigurar" method="post" class="form-horizontal">
                <div class="widget-content nopadding tab-content">
                    ...
                    <div id="menu5" class="tab-pane fade">
                        <div class="control-group">
                            <div class="span8">
                                <span6 class="span10" style="margin-left: 1em;"> Defina a vizualização padrão, onde o que ficar checado será exibida na listagem de Agendamentos por padrão. </span6>
                                <div class="span10">
                                    ...
                                    <label> <input <?= @in_array("Aguardando Materiais", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Aguardando Materiais"> <span class="lbl"> Aguardando Materiais </span> </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-actions">
