...
<h2 class="h-two"> Ao Sistema de Controle de Agendamentos</h2>
    <img src="<?php echo base_url() ?>assets/img/dashboard-animate.svg" class="left-login-image" alt="Du-Arte - Versão: <?= $this->config->item('app_version'); ?>">
</div>
<div id="loginbox">
          ...
          <div class="card">
            <div class="content">
              <div id="newlog">
                ...
                <div class="title01">
                  <?= $configuration['app_theme'] == 'white' ? 'assets/img/logo-mapos-branco.png' : '<div style="margin-top: -40px;"><h2>'.$this->config->item('app_name').'</h2></div>'; ?>
                </div>
              </div>
              ...
              <div class="links-uteis"><a href="http://techearte.com.br"><p><?= date('Y'); ?> &copy; Luccas Woiciechoski</p></a>
              </div>
              <a href="#notification" id="call-modal" role="button" class="btn" data-toggle="modal" style="display: none ">notification</a>
              <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-header">
                  <h4 id="myModalLabel">Du-Arte</h4>
                </div>
