                                ...
                                <div class="widget-content">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label>
                                                    <input name="menuTi" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Menu TI</span>
                                                </label>
                                            </td>
                                             <td>
                                                <label>
                                        ...
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="vAreaClient" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Ver Menu Clien.</span>
                                                </label>
                                            </td>
                                         </tr>
                                        </tbody>
