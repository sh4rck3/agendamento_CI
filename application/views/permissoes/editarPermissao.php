...
<div class="span12" style="margin-left: 0">
    ...
    if ($permissoes['rFinanceiro'] == '1') {
        echo 'checked';
                                    ...
                                    <td>
                                        <label>
                                            <input <?php echo (isset($permissoes['vRelatorio']) && $permissoes['vRelatorio'] == 1) ? 'checked' : ''; ?> name="vRelatorio" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Ver menu Relat.</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php echo (isset($permissoes['vAreaClient']) && $permissoes['vAreaClient'] == 1) ? 'checked' : ''; ?> name="vAreaClient" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Ver area Clien.</span>
                                        </label>
                                    </td>
                                </tr>
                                <tr>
    ...
    if ($permissoes['cBackup'] == '1') {
        echo 'checked';
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php echo (isset($permissoes['vConfig']) && $permissoes['vConfig'] == 1) ? 'checked' : ''; ?> name="vConfig" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Ver Config.</span>
                                        </label>
                                    </td>
                                </tr>
                                </tbody>
