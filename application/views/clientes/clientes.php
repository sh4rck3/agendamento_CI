<div class="new122">
    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'aCliente')) { ?>
        ...
        <a href="<?php echo base_url(); ?>index.php/clientes/adicionarFornecedor" class="button btn btn-mini btn-success" style="max-width: 165px; float: right; margin-top: -44px;">
            <span class="button__icon"><i class='bx bx-plus-circle'></i></span><span class="button__text2">
                Add Fornecedor
            </span>
        </a>
