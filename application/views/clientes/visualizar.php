<div class="widget-box">
    <div class="widget-title" style="margin: 0;font-size: 1.1em">
        <ul class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#tab2">Agendamentos</a></li>
                ...
                <table class="table table-bordered ">
                    ...
                    foreach ($results as $r) {
                        ...
                        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eOs')) {
                            echo '<a href="' . base_url() . 'index.php/os/editar/' . $r->idOs . '" class="btn btn-info tip-top" title="Editar"><i class="fas fa-edit"></i></a>';
                        }
