...
<html lang="pt-br">
<head>
    <title>Agendamentos<?php echo $result->idOs ?>_<?php echo $result->nomeCliente ?></title>
    <meta charset="UTF-8" />
                        ...
                        <table class="table table-condensed">
                            <tbody>
                                <?php if ($emitente == null) { ?>
                                    ...
                                    <td style="width: 18%; text-align: center"><b>N° AG:</b> <span><?php echo $result->idOs ?></span></br> </br> <span>Emissão: <?php echo date('d/m/Y') ?></span></td>
                                    </span>
                                    </td>
                                    </tr>
                                <?php } ?>
