            ...
            <div class="widget-content nopadding tab-content">
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active" id="tabDetalhes"><a href="#tab1" data-toggle="tab">Detalhes do Agendamento</a></li>
                    </ul>
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    <div class="span12" style="padding: 1%">
                                        ...
                                        <div class="span4">
                                            ...
                                            <input id="funcionario" class="span12" type="text" name="funcionario" value="" />
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span3">
                                            ...
                                            <select class="span12" name="status" id="status" value="">
                                                ...
                                                <option value="Aguardando Materiais">Aguardando Materiais</option>
                                            </select>
                                        </div>
                                        <div class="span3">
                                            <label for="dataFinal">Data<span class="required">*</span></label>
                                            <input id="dataInicial"  type="hidden" name="dataInicial" value="<?php echo date('d/m/Y'); ?>" />
                                        ...
                                        <div class="span3">
                                            ...
                                            <input id="horario" autocomplete="off" class="span12" type="time" name="horario" value="" />
                                        </div>
