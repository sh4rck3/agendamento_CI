        ...
        <div class="widget-box">
            <div class="widget-title" style="margin: -20px 0 0">
                ...
                <div class="buttons">
                    ...
                    <a title="Visualizar" class="button btn btn-primary" href="<?php echo site_url() ?>/os/visualizar/<?php echo $result->idOs; ?>">
                      <span class="button__icon"><i class="bx bx-show"></i></span><span class="button__text">Visualizar</span></a>
                    <a target="_blank" title="Imprimir Papel A4" class="button btn btn-mini btn-inverse" href="<?php echo site_url() ?>/os/imprimir/<?php echo $result->idOs; ?>">
                      <span class="button__icon"><i class="bx bx-printer"></i></span> <span class="button__text">Papel A4</span></a>
                    <a target="_blank" title="Imprimir Cupom Não Fiscal" class="button btn btn-mini btn-inverse" href="<?php echo site_url() ?>/os/imprimirTermica/<?php echo $result->idOs; ?>">
...
<!--                        <li id="tabProdutos"><a href="#tab2" data-toggle="tab">Produtos</a></li>-->
                    ...
                    <div class="tab-content">
                            ...
                            <div class="span12" id="divCadastrarOs">
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span4">
                                            <label for="funcionario">Profissional<span class="required">*</span></label>
                                            <input id="funcionario" class="span12" type="text" name="funcionario" value="<?php echo $result->funcionario ?>" />
                        ...
                        echo 'selected';
                                                ...
                                                <option <?php if ($result->status == 'Aguardando Materiais') {
                        echo 'selected';
                    } ?> value="Aguardando Materiais">Aguardando Materiais
                                                </option>
                                            </select>
                                        </div>
                                        <div class="span3">
                                            ...
                                            <input id="dataInicial"  type="hidden" name="dataInicial" value="<?php echo date('d/m/Y', strtotime($result->dataInicial)); ?>" />
                                        </div>
                                        <div class="span3">
                                            <label for="horario">Horário<span class="required">*</span></label>
                                            <input id="horario" autocomplete="off" class="span12" type="time" name="horario" value="<?php echo $result->horario ?>" />
                                        </div>
...
<div id="modal-faturar" class="modal hide fade widget_box_vizualizar4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="formFaturar" action="<?php echo current_url() ?>" method="post">
        <div class="modal_header_anexos">
            ...
            <h3 id="myModalLabel">Faturar Agendamento</h3>
        </div>
        <div class="modal-body">
            <div class="span12 alert alert-info" style="margin-left: 0"> Obrigatório o preenchimento dos campos com asterisco.</div>
            <div class="span12" style="margin-left: 0">
                <label for="descricao">Descrição</label>
                <input class="span12" id="descricao" type="text" name="descricao" value="Fatura de AG Nº: <?php echo $result->idOs; ?> " />
            </div>
            <div class="span12" style="margin-left: 0">
                <div class="span12" style="margin-left: 0">
                    ...
                    <input type="hidden" name="funcionario" id="funcionario" value="<?php echo $result->funcionario; ?>">
                </div>
            </div>
            <div class="span12" style="margin-left: 0">
