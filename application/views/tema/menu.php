...
<nav id="sidebar">
    <div id="newlog">
        <div class="icon2" style="margin-top: -10px;">
            <img src="<?php echo base_url() ?>assets/img/logo-two.png">
        </div>
        <div class="title1">
            <?= $configuration['app_theme'] == 'white' ? '<img src="' . base_url() . 'assets/img/logo-mapos.png">' : '<div style="margin-top: -10px; color: white;"><h2>'.$this->config->item('app_name').'</h2></div>'; ?>
        </div>
    </div>
