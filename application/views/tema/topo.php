...
<head>
  <title><?= $configuration['app_name'] ?: 'Du-Arte' ?></title>
  <meta charset="UTF-8" />
  ...
  <div id="user-nav" class="navbar navbar-inverse">
    ...
    <ul class="nav">
      <li class="dropdown">
        ...
        <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vAreaClient')) { ?>
        ...
        <?php } ?>
          ...
          <li class=""><a title="Comissão" href="<?= site_url('mapos/minhaComissao'); ?>"><span class="text">Minha Comissão</span></a></li>
          <li class="divider"></li>
